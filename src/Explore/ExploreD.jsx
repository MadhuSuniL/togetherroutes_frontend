...
const ExploreD = () => {
  ...
  const res = data.map((place) => {
    ...
    return (
        ...
        <h1 className='text-center m-4 mt-2  bg-sky-400 rounded-md text-white  text-2xl  font-semibold p-1'>{data.length} Best Places to Visit in <span className='text-green-800'>{titleCase(contry)} </span></h1>
        {/* cRDS */}
